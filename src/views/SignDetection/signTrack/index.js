/**
 * @license
 * Based of Handtrack.js by Victor Dibia.
...
const MODEL_URL = 'https://raw.githubusercontent.com/gmacmaster/signSpeak/master/models/try10/model.json';
...
export class ObjectDetection {
  constructor(modelParams) {
    this.MODEL_URL = basePath + "/model.json";
  ...
  async detect(input) {
    ...
    const batched = tf.tidy(() => {
      const imageTensor = tf.browser.fromPixels(input).asType('int32');
    ...
    const self = this;
    return this.model.executeAsync(batched.asType('int32')).then(function (result) {
